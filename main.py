...
from Utils.cleanup import TwitterCleanuper
from Utils.preprocessing import TwitterData
from Utils.word2vec import Word2VecProvider
    ...
    if use_cache:
        ...
        with multiprocessing.Manager() as manager:
            ...
            preprocess_testing = Process(target=preprocess, args=(
                results, "data/test.csv", True, "test", min_occurrences, test_data_file_name,))
...
if __name__ == "__main__":
    ...
    def main():
        ...
        for m in range(3, 4):
            ...
            # bad_predictions.to_csv("data/not_predicted.csv", index_label="idx")
            #
            # continue
            for classifier in classifiers:
                ...
                results_df.to_csv("results/results_" + str(type(classifier).__name__) + "_train.csv", index_label="idx")
